...
if __name__ == '__main__':
    ...
    #set up aws message
    #client = mqtt.Client(client_id = 'client_id2')
    #client.on_connect = on_connect
    #clent.on_message = on_message
    #client.tls_set(ca_certs='/home/baa/rootCA.pem',certfile='/home/baa/cert.pem',keyfile='/home/baa/privateKey.pem',tls_version=
    ...
    for s in range(nSamples):
        ...
        #for det in sample.keys():
         #   print 'det is', det
          #  message = {}
           # message['serialnumber'] = det
            #message['utc'] = string(sample[det]['time'])
            #message['spectrum']=sample[det]['spectrum']
